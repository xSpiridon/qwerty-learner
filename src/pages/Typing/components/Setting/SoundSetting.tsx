      ...
      <ScrollArea.Viewport className="h-full w-full px-3">
        <div className={styles.tabContent}>
          <div className={styles.section}>
            <span className={styles.sectionLabel}>Pronunciation of words</span>
            ...
            <div className={styles.block}>
              <span className={styles.blockLabel}>double the speed</span>
              <div className="flex h-5 w-full items-center justify-between">
                <Slider.Root
          ...
          {window.speechSynthesis && (
            <div className={styles.section}>
              <span className={styles.sectionLabel}>Interpretation and Pronunciation</span>
              <div className={styles.switchBlock}>
          ...
          <div className={styles.section}>
            <span className={styles.sectionLabel}>keypad tone</span>
            <div className={styles.switchBlock}>
            ...
            <div className={`${styles.block}`}>
              <span className={styles.blockLabel}>Key Sound</span>
          ...
          <div className={styles.section}>
            <span className={styles.sectionLabel}>effect sound</span>
            <div className={styles.switchBlock}>
