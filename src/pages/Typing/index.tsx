...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (!IsDesktop()) {
      setTimeout(() => {
        alert(
          ' Qwerty Learner The purpose of this program is to improve the efficiency of English input for keyboard workers. Currently, it has not been adapted to the mobile terminal, so we hope that you will use the desktop browser to access it. If you are using a tablet device such as an Ipad, you can use an external keyboard to use this software.',
        )
      }, 500)
    }
  }, [])
