        ...
        {isCounting ? (
          <div className="mt-6 flex w-full flex-col items-center gap-4">
            ...
            <span className="w-full text-center text-gray-600 dark:text-gray-300">
              Favorite Shortcuts<span className="ml-2 text-indigo-600 dark:text-indigo-500">{IS_MAC_OS ? '⌘' : 'Ctrl'} + D</span>
            </span>
          </div>
        ) : (
    ...
    >
      <div className="fixed right-1 top-4 flex w-150 flex-col items-center justify-evenly rounded-2xl bg-white p-12 shadow-2xl dark:bg-gray-800">
        ...
        <span className="pb-4 text-xl text-gray-600 dark:text-gray-50">
          Keep practicing to improve your language skills. Will <span className="text-indigo-600">「Qwerty Learner」</span>save to favorites and never get lost!
        </span>
        {content}
      </div>
    </Transition>
